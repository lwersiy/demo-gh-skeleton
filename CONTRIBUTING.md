...
issue](https://github.com/cisagov/demo-gh-skeleton/issues) in this
...
request](https://github.com/cisagov/demo-gh-skeleton/pulls), you will
...
```console
cd demo-gh-skeleton
pyenv virtualenv <python_version_to_use> demo-gh-skeleton
pyenv local demo-gh-skeleton
